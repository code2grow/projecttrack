...
public class UserMother {
	...
	public static User makeProjectManager(Department department) {
		return new User(new UserId("proj_mgr"), new PersonName("Sean", "Sullivan"), new Password("faces"), makeRoleTypeSet(RoleType.PROJECT_MANAGER,
	...
	public static User makeSystemsManager(Department department) {
		return new User(new UserId("sys_mgr"), new PersonName("Ed", "LaCalle"), new Password("faces"), makeRoleTypeSet(
	...
	public static User makeQAManager(Department department) {
		return new User(new UserId("qa_mgr"), new PersonName("Tracey", "Burroughs"), new Password("faces"), makeRoleTypeSet(RoleType.QA_MANAGER, RoleType.PROJECT_APPROVER,
    		RoleType.PROJECT_VIEWER),
				department);
	}

	public static User makeDevelopmentManager(Department department) {
		return new User(new UserId("dev_mgr"), new PersonName("Devora", "Shapiro"), new Password("faces"), makeRoleTypeSet(RoleType.DEVELOPMENT_MANAGER,
    		RoleType.PROJECT_APPROVER, RoleType.PROJECT_VIEWER),
				department);
	}

	public static User makeBusinessAnalyst(Department department) {
		return new User(new UserId("analyst"), new PersonName("Marvin", "Walton"), new Password("faces"), makeRoleTypeSet(RoleType.BUSINESS_ANALYST,
    		RoleType.PROJECT_APPROVER, RoleType.PROJECT_VIEWER),
				department);
	}
	...
	public static User makeUpperManager() {
		return new User(
				new UserId("upper_mgr"),
				new PersonName("Casey", "Langer"),
				new Password("faces"),
  ...
  public static User makeMarketingDepartmentProjectManager(
    ...
    return new User(new UserId("proj_mgr2"), new PersonName("John", "Doe"), new Password("faces"), makeRoleTypeSet(RoleType.PROJECT_MANAGER,
    		RoleType.PROJECT_APPROVER, RoleType.PROJECT_CREATOR),
				department);
  }
